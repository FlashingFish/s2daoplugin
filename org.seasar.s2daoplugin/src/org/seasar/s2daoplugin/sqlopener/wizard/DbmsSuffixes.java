...
public class DbmsSuffixes {

	private static final String BUNDLE_NAME = "dbms_suffix";
	private static final String BUNDLE_BASE =
		DbmsSuffixes.class.getPackage().getName() + "." + BUNDLE_NAME;
	
	public static String getDbmsName(String suffix) {
